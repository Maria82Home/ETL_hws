/*
chcp 65001 && spark-shell -i \GeekBrains\Data_Engineer\ETL\seminars\Geekbrains_ETL\s1.scala --conf "spark.driver.extraJavaOptions=-Dfile.encoding=utf-8"
*/
...
var df1 = spark.read.format("com.crealytics.spark.excel")
        ...
        .option("header", "true")
        .format("excel")
        .load("C:/GeekBrains/Data_Engineer/ETL/seminars/Geekbrains_ETL/Сем1.xlsx")
		df1.show()
